...
filename = 'Images/Pol_Con_Sim.gif';

for p_theta_w4_1 = linspace(0,90,5)
    for p_theta_w2_2 = linspace(0,90,5)
        for p_theta_w4_3 = linspace(0,90,5)
        ...
        %     figure(1),plot3(t,ex_o,t*0,'r',t,t*0,ey_o,'b',t,ex_o,ey_o,'g','LineWidth',2);
        %     axis([-1,1,-1,1,-1,1]),grid on,view(90,0);

            figure(1),plot3(s1,s2,s3,'.','Color','black','MarkerSize',10),hold on;
            title('Poincare sphere'),xlabel('S1'),ylabel('S2'),zlabel('S3');
            axis([-1,1,-1,1,-1,1]),grid on,view(50,10);
